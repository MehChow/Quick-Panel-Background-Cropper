const en = {
  translation: {
    ...
    customize: {
      ...
      buttonIdentifierContentTitle: "Show labels",
      buttonIdentifierContentBoth: "Both",
      buttonIdentifierContentIcon: "Icon",
      buttonIdentifierContentNone: "None",
      buttonIdentifierContentBothAccessibility: "Show icon and text",
      buttonIdentifierContentIconAccessibility: "Show icon only",
      buttonIdentifierContentNoneAccessibility: "Hide icon and text",
      buttonIdentifierOpacity: "Label intensity",
      horizontalIdentifierPosition: "Horizontal label position",
